    ...
    <body>
        ...
        <div class="container">
            ...
            <form id="contact" name="cadastrarusuario" action="CadastrarUsuario" method="POST">
                ...
                <fieldset>
                    <input  placeholder="username" type="text" name="nomeUsuario">
                </fieldset>
                ...
                <fieldset>
                    <button href="start.jsp" class="cadastrar" type="submit" name="cadastrar" value="Cadastrar">Cadastrar</button>
                </fieldset>
            </form>
            <ul>
