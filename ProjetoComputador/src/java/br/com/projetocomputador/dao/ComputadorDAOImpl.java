...
public class ComputadorDAOImpl implements GenericDAO {
    ...
    public Integer cadastrarComputador(Object object) {
        ...
        String sql = "Insert into computadores(ssdcomputador, ramcomputador, idtipo, idproduto) values (?, ?, ?, ?) returning idcomputador;";
        try {
            ...
            if (rs.next()) {
                idComputador = rs.getInt("idcomputador");
            }
        } catch (Exception ex) {
